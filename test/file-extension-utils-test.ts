...
describe('file-extension-utils', function() {
  ...
  describe('getExtension()', function() {
    it('return right extensions', function() {
      ...
      expect(getExtension({ uri: 'file:///project/app.ts' })).toEqual('.ts');
  ...
  describe('hasExtension()', function() {
    it('checks file has one of the provides extensions', function() {
      expect(hasExtension({ uri: 'file:///project/app/app.js' }, '.js', '.ts', '.hbs')).toBeTruthy();
      expect(hasExtension({ uri: 'file:///project/app/application.hbs' }, '.js', '.ts', '.hbs')).toBeTruthy();
      expect(hasExtension({ uri: 'file:///project/app/application.handlebars' }, '.js', '.ts', '.hbs')).toBeTruthy();
